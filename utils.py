...
class IPTables(object):
    ...
    def route_to_sslstrip(self, phys, upstream):
	        ...
	        #bash_command('iptables -t nat -A PREROUTING -p tcp --destination-port 80 -j REDIRECT --to-port 80')
	        #bash_command('iptables -t nat -A PREROUTING -p tcp --destination-port 443 -j REDIRECT --to-port 443')
